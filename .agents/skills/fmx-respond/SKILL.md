...
- Apply [`AGENTS.md`'s presentation preferences](../../../AGENTS.md#presentation-preferences) to these captain-directed public replies, within the public-safety limits above.
